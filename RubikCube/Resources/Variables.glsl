...
#define BITS_PER_ROW (N <= 4u ? 3u : 4u)
#define BITS_PER_ROW_MASK ((1u << BITS_PER_ROW) - 1u)
#define IDENTITY STUB
...
#define MAX_CUBIE_L1 (1 << (BITS_PER_ROW * N))
//#define MAX_CUBIE_L1 (N * ((1 << (BITS_PER_ROW - 1)) + N - 1))   // stara formuła, dopasowana do nowej nazwy BITS_PER_ROW
...
//#define PAIR EQUAL
//#define SSIGN -1
#define MEASURE P2+NS_SeedGpu90Mut10L1
