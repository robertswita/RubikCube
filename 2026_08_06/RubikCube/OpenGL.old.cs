...
namespace TGL
{
    public static class OpenGL
    {
        ...
        public delegate void glBindBuffer(uint target, int buffer);
        public delegate void glBindBufferBase(uint target, int index, int buffer);
        //public delegate void glBufferData(int target, int size, IntPtr data, int usage);
        public unsafe delegate void glBufferData(uint target, int size, void* data, int usage);
        public unsafe delegate void glBufferSubData(uint target, int offset, int size, void* data);
        //public delegate void glGetBufferSubData(int target, int offset, int size, IntPtr data);
        public unsafe delegate void glGetBufferSubData(uint target, int offset, int size, void* data);
        ...
        public static glBufferSubData BufferSubData { get { return GetProc<glBufferSubData>(); } }
        ...
        //public static void GetBufferSubDatafv(uint target, int offset, float[] data)
        //{
        //    IntPtr dataPtr = Marshal.AllocHGlobal(data.Length * sizeof(float));
        ...
        //    Marshal.FreeHGlobal(dataPtr);
        //}
        //public static void GetBufferSubDataiv(uint target, int offset, int[] data)
        //{
        //    IntPtr dataPtr = Marshal.AllocHGlobal(data.Length * sizeof(int));
        //    GetProc<glGetBufferSubData>()(target, offset, data.Length * sizeof(int), dataPtr);
        //    Marshal.Copy(dataPtr, data, 0, data.Length);
        //    Marshal.FreeHGlobal(dataPtr);
        //}
        ...
        public static glUniform1ui Uniform1ui { get { return GetProc<glUniform1ui>(); } }
